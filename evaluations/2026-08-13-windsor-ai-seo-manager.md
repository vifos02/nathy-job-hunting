...
| Skill Match (10%) | 2/10 | **Hard gap flagged in CLAUDE.md.** The JD states the team codes SQL — this is a stated skill expectation, not a nice-to-have. SQL is explicitly listed as a skill Nathália does not have. **You have:** AHREFs, Botify, GSC, GA4, Looker Studio, content strategy, on-page SEO, page launches, migrations, competitive analysis. But SQL as a team norm is a dealbreaker dimension mismatch per the rubric. |
| **Final Score** | **6.8/10** | *(8×0.30)+(8×0.25)+(5×0.20)+(8×0.15)+(2×0.10) = 2.4+2.0+1.0+1.2+0.2 = 6.8* — corrected 2026-08-13 after reviewing JD SQL requirement |

**Verdict: CONSIDER** *(was APPLY at 7.3 — corrected: SQL hard gap per CLAUDE.md)*
