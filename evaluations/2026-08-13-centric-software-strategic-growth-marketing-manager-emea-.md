<!-- job_id: linkedin:af76efabc0ec -->
---
**Centric Software — Strategic Growth Marketing Manager - EMEA Retail**
*Source: https://de.linkedin.com/jobs/view/strategic-growth-marketing-manager-emea-retail-at-centric-software-4423083137 | Evaluated: 2026-08-13*
...
1. **Role Fit is strong.** Title, scope (growth, demand gen, team leadership, cross-functional), and seniority level match your 16-year trajectory. You've done this type of work successfully at CondoConta and Lumine.

2. **100% Remote + no work-auth blocker.** Workable from Spain now, seamlessly from Brazil from November 2026. No EU work permit requirement mentioned. Timezone is EU-friendly.

3. **Legitimate, growing SaaS company.** Centric Software is credible, VC-backed, with real enterprise clients. Likely to offer competitive comp (€50k–€75k) and a professional, English-speaking international team.

---

### Top 3 Concerns (be honest)

1. **Vertical mismatch.** You have no hands-on Retail/Fashion/CPG experience. Centric's entire GTM is vertical-focused (Grocery, Multi-Category Retail, later Fashion/Luxury). You'll need to